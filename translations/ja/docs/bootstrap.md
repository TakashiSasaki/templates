...
- **installer script revision** `cc9c7b26168dd5875c485e8fc9343fa57d9f44a8`: remoteで実行するbootstrap scriptを固定します。
- **skill source revision** `22af789aa6e41c646f874d26c4885dd54584e690`: installerが取得する `skills/agent-policy/` subtreeを固定します。
