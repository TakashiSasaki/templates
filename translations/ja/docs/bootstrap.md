...
- **installer script revision** `4db0e1d9a71385f572118407c585c56773bea8bc`: remoteで実行するbootstrap scriptを固定します。
- **skill source revision** `27a3319a3785250236bee056fd917379c245aaef`: installerが取得する `skills/agent-policy/` subtreeを固定します。
