...
- **installer script revision** `f4457c90854db34c3ce8e1c381f67a4d7d5ea523`: remoteで実行するbootstrap scriptを固定します。
- **skill source revision** `344aaf0b140e3c066363297012bb866efbc106e4`: installerが取得する `skills/agent-policy/` subtreeを固定します。
