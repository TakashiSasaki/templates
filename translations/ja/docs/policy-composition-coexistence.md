...
| Policy generation toolchain | `b764b00d532f82fd6152ace13941784828818ec5` | AGENTS.md・reviewer 指示・Policy lock・canonical progressive-discovery Skill projection の生成 |
...
現在の台帳は verified 558 件、deferred 20 件です。
