...
- **installer script revision** `cc9c7b26168dd5875c485e8fc9343fa57d9f44a8` identifies the remotely executed stdlib-only bootstrap script;
- **skill source revision** `22af789aa6e41c646f874d26c4885dd54584e690` identifies the `skills/agent-policy/` tree that the installer downloads and atomically installs; and
