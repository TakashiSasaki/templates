...
7. Restored a branch-appropriate documentation build and GitHub Pages deployment workflow for `templates:policy` without importing the former workflow history or fetching unrelated branches.
...
2. Complete the repository Pages settings and custom-domain cutover, then verify the public endpoint as described in `documentation-publication.md`.
