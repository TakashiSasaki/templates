...
This directory contains architecture, contract, evidence, distribution, and readiness documentation for maintainers of the `webapp` template.
...
- [Distribution classification](distribution-classification.json) — Machine-readable classification of top-level distribution and maintainer paths.
...
- [Consumer architecture index](../../template/docs/architecture/index.md) — Shows the architecture documentation that is actually included in copied repositories.
