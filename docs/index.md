...
- [WebMCP capability guide](https://github.com/TakashiSasaki/templates/blob/96e7b4d874d2a71316ed1b9c3165bfb5716aff4b/docs/guides/webmcp-capability.md) — Select and validate the browser-exposed WebMCP capability without confusing it with server-side MCP.
...
- [Publication catalog](https://github.com/TakashiSasaki/templates/blob/96e7b4d874d2a71316ed1b9c3165bfb5716aff4b/docs/publication-catalog.json) — machine-readable allowlist for reader documents and publication assets.
- [Publication classification](https://github.com/TakashiSasaki/templates/blob/96e7b4d874d2a71316ed1b9c3165bfb5716aff4b/docs/publication-classification.json) — explicit exclusions for repository Markdown outside the reader publication surface.
- [Composition glossary](https://github.com/TakashiSasaki/templates/blob/96e7b4d874d2a71316ed1b9c3165bfb5716aff4b/docs/glossary.yml) — Composition-owned terminology records used by publication validation.
