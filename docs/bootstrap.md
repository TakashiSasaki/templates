...
- **installer script revision** `4db0e1d9a71385f572118407c585c56773bea8bc` pins the remotely executed bootstrap script;
- **skill source revision** `27a3319a3785250236bee056fd917379c245aaef` pins the `skills/agent-policy/` subtree downloaded by that script; and
