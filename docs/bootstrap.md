...
- **installer script revision** `17ac1aae0e9fa3fa272ce2798ab5d3be71c1bd61` pins the remotely executed bootstrap script;
- **skill source revision** `a7123c4bb12942d690193e9e73f64cd12e33c00d` pins the `skills/agent-policy/` subtree downloaded by that script; and
