...
- **installer script revision** `bf3db6dcfa3b8c79d5d90a75c1ed277a4b18c9d3` pins the remotely executed bootstrap script;
- **skill source revision** `f3347021f6cdc4fcba3faecd01c9ab69ef0e2910` pins the `skills/agent-policy/` subtree downloaded by that script; and
