...
The same non-deploying check runs weekly and can be started manually to detect documentation drift. No workflow on `skill` deploys GitHub Pages; publication is outside this branch's authority.
