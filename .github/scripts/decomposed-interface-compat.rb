...
# Transitional parser adapter for the Phase 2 interface split.
#
...
#
# Contract completeness is validated independently by
# validate-decomposed-interface-contracts.rb. The repository documents remain
# decomposed and have one source of truth.
