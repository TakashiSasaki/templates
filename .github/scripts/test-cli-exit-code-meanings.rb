...
cases = [
  ...
  ["rejects timeout as the zero meaning", "Operation timed out", "Invalid invocation", false],
  ["rejects cancellation as the zero meaning", "Cancelled by user", "Invalid invocation", false],
  ["rejects an aborted operation as the zero meaning", "Operation aborted", "Invalid invocation", false],
