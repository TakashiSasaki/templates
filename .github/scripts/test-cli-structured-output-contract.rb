...
cases = [
  ...
  ["accepts a named environment assignment", "environment variable: SKILL_OUTPUT=json", "JSON", "contractVersion", true],
  ...
  ["rejects an environment variable name without a value", "environment variable: SKILL_OUTPUT", "JSON", "contractVersion", false],
  ["rejects TBD inside a named option selector", "option: TBD", "JSON", "contractVersion", false],
  ["rejects pending inside a named subcommand selector", "subcommand: pending", "JSON", "contractVersion", false],
  ["rejects TBD as an option argument", "--output TBD", "JSON", "contractVersion", false],
  ["rejects DEFAULT as an environment value", "SKILL_OUTPUT=DEFAULT", "JSON", "contractVersion", false],
