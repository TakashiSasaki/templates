...
# migration and therefore remain byte-identical provenance checks. Routes is
# intentionally excluded: the current authority has evolved through explicit
# breaking schema versions after the legacy snapshot.
...
class LegacyWebappSnapshotTests(unittest.TestCase):
    ...
    def test_versioned_routes_have_evolved_from_legacy_snapshot(self) -> None:
