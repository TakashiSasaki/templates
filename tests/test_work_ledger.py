...
def test_work_ledger_preserves_storage_and_acceptance_boundaries():
    ...
    for required in (
        ...
        "exact-revision-bound ci for the old sha",
        "do not mark explicitly tree-and-context-bound ci stale solely",
        "exact-head review remains stale after any proposed-head change",
