...
try:
    ...
    from site_website_contract import public_path

try:
    from scripts.assemble_publications import AssemblyError, Manifest, load_manifest
except ImportError:
    from assemble_publications import AssemblyError, Manifest, load_manifest
