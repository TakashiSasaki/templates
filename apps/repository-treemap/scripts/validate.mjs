...
const required = [
  ...
  "src/js/fullscreen.js", "src/js/treemap-view.js", "src/config/defaults.json"
];
...
if (index.includes('id="branch-select"')) throw new Error("branch selection must use tabs rather than the legacy select");
